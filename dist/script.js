...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('11-06-2022');
...
var changeModalState = function changeModalState(state) {
  var windowShape = document.querySelectorAll('.balcon_icons_img > img'),
      windowWidth = document.querySelectorAll('#width'),
      windowHeight = document.querySelectorAll('#height'),
      windowType = document.querySelectorAll('#view_type'),
      windowProfile = document.querySelectorAll('.checkbox');
  windowShape.forEach(function (item, i) {
...
var checkNumInput = function checkNumInput(input) {
...
var gallery = function gallery() {
  var worksSection = document.querySelector('.works'),
      ...
      bigImg = document.createElement('img'); // imagePopup.classList.add('popup'); //поменять класс
  ...
  previews.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      var srcBigImg = e.target.parentNode.getAttribute('href');
...
var modal = function modal() {
  function bindModal(triggerSelector, modalSelector) {
    var closeSelector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.popup_close';
...
var tabs = function tabs(headerSelector, tabSelector, tabContentSelector, activeClass) {
